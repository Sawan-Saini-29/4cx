        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <View style={{ height: 60, width: 351, marginTop: 20, alignSelf: "center", justifyContent: "space-between" }}>
                    <Text style={{ fontWeight: 500, fontSize: 14, lineHeight: "100%", color: "rgba(255, 255, 255, 1)" }}>First Name</Text>
                    <TextInput
                ...
                <View style={{ height: 60, width: 351, marginTop: 20, alignSelf: "center", justifyContent: "space-between" }}>
                    <Text style={{ fontWeight: 500, fontSize: 14, lineHeight: "100%", color: "rgba(255, 255, 255, 1)" }}>Last Name</Text>
                    <TextInput
                ...
                <View style={{ height: 60, width: 351, marginTop: 20, alignSelf: "center", justifyContent: "space-between" }}>
                    ...
                    <Text style={{ fontWeight: 500, fontSize: 14, lineHeight: "100%", color: "rgba(255, 255, 255, 1)" }}>Address</Text>
                    <Text style={{ fontWeight: 500, fontSize: 14, lineHeight: "100%", color: "rgba(0, 136, 255, 1)",textDecorationLine:"underline" }}>Enter Manually</Text>
                    </View>
                    <TextInput
                ...
                <View style={{ height: 60, width: 351, marginTop: 20, alignSelf: "center", justifyContent: "space-between" }}>
                    <Text style={{ fontWeight: 500, fontSize: 14, lineHeight: "100%", color: "rgba(255, 255, 255, 1)" }}>Date of Birth (MM/DD/YYYY)</Text>
                    <TextInput
                ...
                <View style={{ height: 60, width: 351, marginTop: 20, alignSelf: "center", justifyContent: "space-between" }}>
                    <Text style={{ fontWeight: 500, fontSize: 14, lineHeight: "100%", color: "rgba(255, 255, 255, 1)" }}>Last 4 Digits of Your SSN</Text>
                    <TextInput
